...
router.post('/product-variation', verifyJWTorRefreshJWT, validateDataMiddleWare(productVariationSchema), createProductVariationController);
router.put('/product-variation/:id', verifyJWTorRefreshJWT, validateDataMiddleWare(productVariationUpdateSchema), updateProductVariationController);
router.delete('/product-variation/:id', verifyJWTorRefreshJWT, deleteProductVariationController);
...
router.post('/product-variation-option', verifyJWTorRefreshJWT, validateDataMiddleWare(productVariationOptionSchema), createProductVariationOptionController);
router.put('/product-variation-option/:id', verifyJWTorRefreshJWT, validateDataMiddleWare(productVariationOptionSchema), updateProductVariationOptionController);
router.delete('/product-variation-option/:id', verifyJWTorRefreshJWT, deleteProductVariationOptionController);
...
router.put('/product-variation-configuration-bysku/:skuId', verifyJWTorRefreshJWT, validateDataMiddleWare(configurationSchema), updateVariationConfigurationController);
