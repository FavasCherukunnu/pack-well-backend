import { NextFunction, Request, Response } from 'express'; // Express import
import { prisma } from '../../app.js';
import { ApiResponse } from '../../utils/ApiResponse.js';


// Controller to create/update the default mobile number
export const setDefaultMobileNumberController = async (req: Request, res: Response, next: NextFunction) => {
...
export const getDefaultMobileNumberController = async (req: Request, res: Response, next: NextFunction) => {
    try {
